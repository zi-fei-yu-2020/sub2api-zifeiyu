...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	groupDetailStatsRepository := repository.NewGroupDetailStatsRepository(db)
	groupDetailStatsService := service.NewGroupDetailStatsService(groupDetailStatsRepository)
	groupHandler := admin.NewGroupHandler(adminService, dashboardService, groupCapacityService, groupDetailStatsService, configConfig)
	...
	defaultLoadBalancer := payment.ProvideDefaultLoadBalancer(client)
