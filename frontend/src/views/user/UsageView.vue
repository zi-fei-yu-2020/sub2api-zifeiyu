<template>
  <AppLayout>
    <div class="space-y-6">
          ...
          <div class="flex w-full flex-wrap items-center justify-end gap-3 sm:w-auto">
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-lg border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-900"
              >
                <button
      ...
      <div v-if="errorViewEnabled" class="flex gap-2 border-b border-slate-200 dark:border-slate-800">
