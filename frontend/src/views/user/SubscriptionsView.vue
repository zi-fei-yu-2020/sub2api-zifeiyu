    ...
    <div class="space-y-6">
      ...
      <div v-else class="grid gap-6 lg:grid-cols-2">
        ...
        >
          <!-- Header -->
          <div
            class="flex items-center justify-between border-b border-slate-100 p-4 dark:border-dark-700"
          >
            <div class="flex items-center gap-3">
              ...
              <div>
                ...
                <p v-if="subscription.group?.description" class="mt-0.5 text-xs text-slate-400 dark:text-dark-400">
                  {{ subscription.group.description }}
                </p>
                <div class="mt-1 flex flex-wrap gap-x-3 gap-y-1 text-[11px] text-gray-400 dark:text-slate-400">
          ...
          <div class="space-y-4 p-4">
            ...
            <div v-if="subscription.expires_at" class="flex items-center justify-between text-sm">
              <span class="text-slate-400 dark:text-dark-400">{{
            ...
            <div v-if="subscription.group?.daily_limit_usd" class="space-y-2">
              ...
              <p
                ...
                class="text-xs text-slate-400 dark:text-dark-400"
              >
            ...
            >
              <div class="flex items-center gap-3">
                <span class="text-4xl text-blue-600 dark:text-emerald-400">∞</span>
                <div>
                  <p class="text-sm font-medium text-emerald-700 dark:text-emerald-300">
                    {{ t('userSubscriptions.unlimited') }}
                  </p>
                  <p class="text-xs text-blue-600/70 dark:text-emerald-400/70">
