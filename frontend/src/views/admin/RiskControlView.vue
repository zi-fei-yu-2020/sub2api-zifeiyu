...
function workerSlotClass(state: WorkerSlotState): string {
  ...
  if (state === 'idle') {
    return 'border-blue-200 bg-emerald-50 text-emerald-700 dark:border-emerald-900/60 dark:bg-emerald-900/20 dark:text-emerald-300'
  }
