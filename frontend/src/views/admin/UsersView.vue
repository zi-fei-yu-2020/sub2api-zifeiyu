  ...
  <AppLayout>
            ...
            <div class="flex items-center gap-2 md:contents">
              ...
              <div class="relative" ref="filterDropdownRef">
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 w-48 rounded-md border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-900"
                >
                  <!-- Built-in filters -->
                  <button
              ...
              <div class="relative" ref="columnDropdownRef">
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-md border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-900"
                >
                  <button
                    ...
                    :class="[
                      ...
                      isForcedVisibleColumn(col.key)
                        ...
                        : 'text-slate-700 hover:bg-slate-100 dark:text-gray-300 dark:hover:bg-dark-700'
                    ]"
                  ...
                  >
                    ...
                    <Icon
                      ...
                      name="check"
                      size="sm"
                      :class="isForcedVisibleColumn(col.key) ? 'text-slate-400 dark:text-slate-400' : 'text-primary-500'"
                      :stroke-width="2"
                    />
                  </button>
                </div>
      ...
      <template #table>
        ...
        >
          ...
          <template #cell-notes="{ value }">
            <div class="max-w-xs">
              <span
                ...
                class="block truncate text-sm text-slate-600 dark:text-slate-400"
              >
          ...
          >
            <div class="max-w-xs">
              <span
                class="block truncate text-sm text-slate-700 dark:text-gray-300"
          ...
          <template #cell-groups="{ row }">
            <div v-if="allGroups.length > 0" class="flex flex-col gap-1">
              ...
              >
                ...
                <span class="text-slate-400 dark:text-dark-400">{{ t('admin.users.exclusiveLabel') }}</span>
                ...
                <div
                  v-if="expandedGroupUserId === row.id"
                  class="absolute left-0 top-full z-50 mt-1.5 min-w-[160px] overflow-hidden rounded-md border border-slate-200 bg-white py-1 text-xs shadow-xl dark:border-slate-700 dark:bg-slate-800"
                >
                  <div class="border-b border-slate-100 px-3 py-1.5 text-[10px] font-medium uppercase tracking-wider text-slate-400 dark:border-slate-700 dark:text-dark-400">
                    {{ t('admin.users.clickToReplace') }}
                  </div>
                  <div
                    v-for="g in getUserGroups(row).exclusive"
                    :key="g.id"
                    class="flex cursor-pointer items-center gap-2 px-3 py-2 text-slate-700 transition-colors hover:bg-primary-50 hover:text-primary-600 dark:text-dark-200 dark:hover:bg-primary-900/30 dark:hover:text-primary-400"
              ...
              >
                <Icon name="globe" size="xs" class="h-3.5 w-3.5 text-slate-400 dark:text-dark-500" />
                <span class="font-medium text-slate-600 dark:text-dark-300">{{ getUserGroups(row).publicGroups.length }}</span>
                <span class="text-slate-400 dark:text-dark-500">{{ t('admin.users.publicLabel') }}</span>
                <!-- Tooltip: 向下弹出 -->
              ...
              <span
                ...
                class="text-xs text-slate-400 dark:text-dark-500"
              >-</span>
            </div>
            <span v-else class="text-xs text-slate-400 dark:text-dark-500">-</span>
          </template>
          ...
          <template #cell-subscriptions="{ row }">
            ...
            <span
              v-else
              class="inline-flex items-center gap-1.5 rounded-md bg-slate-50 px-2 py-1 text-xs text-slate-400 dark:bg-slate-800/50 dark:text-dark-500"
            >
          ...
          <template #cell-balance="{ value, row }">
            <div class="flex items-center gap-2">
              <div class="group relative">
                <button
                  class="font-medium text-slate-900 underline decoration-dashed decoration-gray-300 underline-offset-4 transition-colors hover:text-primary-600 dark:text-white dark:decoration-dark-500 dark:hover:text-primary-400"
              ...
              <button
                ...
                class="rounded px-2 py-0.5 text-xs font-medium text-blue-600 transition-colors hover:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-900/20"
            ...
            <div class="flex items-center gap-1.5">
              ...
              <div class="usage-sort-trigger relative">
                ...
                <div
                  ...
                  class="absolute right-0 top-full z-50 mt-1 min-w-[120px] rounded-md border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-900"
                >
                  <button
                    v-for="metric in (['today', 'total'] as const)"
                    :key="metric"
                    type="button"
                    class="flex w-full items-center justify-between gap-3 px-3 py-1.5 text-left text-xs normal-case tracking-normal hover:bg-slate-100 dark:hover:bg-dark-700"
                  ...
                  <div class="mt-1 border-t border-slate-100 px-3 py-1 text-[10px] normal-case tracking-normal text-slate-400 dark:border-slate-800 dark:text-dark-500">
          ...
          <template #cell-last_used_at="{ value }">
            <span class="text-sm text-slate-400 dark:text-dark-400">
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              ...
              <button
                ...
                :class="[
                  'flex flex-col items-center gap-0.5 rounded-md p-1.5 text-slate-400 transition-colors',
                  row.status === 'active'
                    ? 'hover:bg-orange-50 hover:text-orange-600 dark:hover:bg-orange-900/20 dark:hover:text-orange-400'
                    : 'hover:bg-green-50 hover:text-primary-600 dark:hover:bg-green-900/20 dark:hover:text-green-400'
                ]"
              >
              ...
              <button
                ...
                class="action-menu-trigger flex flex-col items-center gap-0.5 rounded-md p-1.5 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-dark-700 dark:hover:text-white"
                :class="{ 'bg-slate-100 text-slate-900 dark:bg-slate-800 dark:text-white': activeMenuId === row.id }"
              >
    ...
    <Teleport to="body">
      <div
        ...
        class="action-menu-content fixed z-[9999] w-48 overflow-hidden rounded-md bg-white shadow-lg ring-1 ring-black/5 dark:bg-slate-900 dark:ring-white/10"
          ...
          <template v-for="user in users" :key="user.id">
            <template v-if="user.id === activeMenuId">
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 dark:text-gray-300 dark:hover:bg-dark-700"
              >
                <Icon name="key" size="sm" class="text-slate-400" :stroke-width="2" />
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 dark:text-gray-300 dark:hover:bg-dark-700"
              >
                <Icon name="users" size="sm" class="text-slate-400" :stroke-width="2" />
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 dark:text-gray-300 dark:hover:bg-dark-700"
              >
                <Icon name="chartBar" size="sm" class="text-slate-400" :stroke-width="2" />
              ...
              <button
                ...
                class="flex w-full items-center gap-2 px-4 py-2 text-sm text-slate-700 hover:bg-slate-100 dark:text-gray-300 dark:hover:bg-dark-700"
              >
                <Icon name="dollar" size="sm" class="text-slate-400" :stroke-width="2" />
