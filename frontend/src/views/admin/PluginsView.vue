<template>
  <AppLayout>
    <div class="space-y-6">
      <section
        class="flex flex-col gap-4 border-b border-slate-200 pb-5 dark:border-slate-800 sm:flex-row sm:items-end sm:justify-between"
      >
        <div class="min-w-0">
          <h2 class="text-lg font-semibold text-slate-900 dark:text-white">
            {{ t("admin.plugins.title") }}
          </h2>
          <p class="mt-1 max-w-3xl text-sm text-slate-400 dark:text-slate-400">
            {{ t("admin.plugins.description") }}
          </p>
          <div
            class="mt-3 flex flex-wrap gap-2 text-xs text-slate-600 dark:text-gray-300"
          >
      ...
      <div
        ...
        class="flex min-h-56 flex-col items-center justify-center border border-dashed border-slate-300 px-6 text-center dark:border-slate-700"
      >
        <Icon name="cube" size="xl" class="text-slate-400" />
        <p class="mt-3 font-medium text-gray-800 dark:text-gray-200">
          {{ t("admin.plugins.empty") }}
        </p>
        <p class="mt-1 max-w-lg text-sm text-slate-400 dark:text-slate-400">
      ...
      <div v-else class="grid grid-cols-1 gap-4 xl:grid-cols-2">
        <article
          ...
          :key="plugin.id"
          class="card overflow-hidden border border-slate-200 dark:border-slate-800"
        >
          <div
            class="flex flex-wrap items-start justify-between gap-3 border-b border-slate-100 p-5 dark:border-slate-800"
          >
            <div class="min-w-0">
              ...
              <p
                ...
                class="mt-2 text-sm text-slate-600 dark:text-gray-300"
              >
                {{ plugin.description }}
              </p>
            </div>
          ...
          <div class="grid grid-cols-1 gap-x-6 gap-y-4 p-5 md:grid-cols-2">
            ...
            <div>
              ...
              <div class="mt-2 flex flex-wrap gap-2 text-xs">
                <span
                  ...
                  :class="
                    plugin.runtime_healthy
                      ...
                      : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-gray-300'
                  "
                >
                  {{
                    plugin.runtime_healthy
                ...
                <span
                  class="rounded bg-slate-100 px-2 py-0.5 text-slate-600 dark:bg-slate-800 dark:text-gray-300"
                >
              ...
              <p
                ...
                class="mt-3 break-words text-xs text-slate-400"
              >
            ...
            <div class="md:col-span-2">
              <label
                class="flex items-center justify-between gap-4 text-xs font-medium text-slate-600 dark:text-gray-300"
              >
          ...
          <div
            class="flex flex-wrap justify-end gap-2 border-t border-slate-100 px-5 py-4 dark:border-slate-800"
          >
            <button
              type="button"
              class="btn btn-secondary btn-sm"
      ...
      >
        <div
          class="relative min-h-[520px] overflow-hidden bg-slate-50 dark:bg-dark-900"
        ...
        >
          ...
          >
            ...
            <p class="mt-1 max-w-xl text-sm text-slate-400">{{ uiError }}</p>
          </div>
          <iframe
            v-if="uiSession"
            ref="pluginFrame"
