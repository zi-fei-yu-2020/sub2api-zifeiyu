          ...
          <div class="flex flex-1 flex-wrap items-center gap-3">
            <div class="relative w-full sm:w-64">
              <Icon
                name="search"
                size="md"
                class="absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-slate-400"
              />
              <input
                v-model="searchQuery"
                type="text"
          ...
          >
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-xl border border-slate-200 bg-white py-1 shadow-lg dark:border-slate-700 dark:bg-slate-900"
              >
                <button
      ...
      >
          ...
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              <Icon
                ...
                size="sm"
                :stroke-width="2"
                class="cursor-help text-slate-400 transition-colors hover:text-primary-500 dark:text-slate-400 dark:hover:text-primary-400"
              />
              <div
              ...
              >
                <div
                  class="rounded-xl bg-gray-900 p-3 text-white shadow-lg dark:bg-gray-800"
                >
        ...
        <div class="border-t pt-4">
          ...
          <div
            ...
            class="overflow-hidden rounded-xl border border-slate-200 bg-slate-50/50 dark:border-slate-700 dark:bg-slate-900/40"
          >
            <div
              v-if="!createModelsListLoading && createModelsListState.items.length > 0"
              class="flex items-center justify-between gap-2 border-b border-slate-200 bg-slate-50 px-3 py-2 text-xs dark:border-slate-700 dark:bg-slate-900"
            >
              <span class="text-slate-400 dark:text-slate-400">
                {{
              ...
              <div class="flex items-center gap-1.5">
                ...
                <button
                  type="button"
                  class="rounded px-2 py-1 font-medium text-slate-600 transition-colors hover:bg-slate-100 dark:text-gray-300 dark:hover:bg-dark-700"
            ...
            >
              <p v-if="createModelsListLoading" class="text-xs text-slate-400 dark:text-slate-400">
              ...
              <div
                ...
                :key="item.id"
                class="flex items-center gap-2 rounded border border-slate-200 bg-white px-3 py-2 dark:border-slate-700 dark:bg-slate-900"
              >
                <input
                ...
                />
                <span class="min-w-0 flex-1 break-all text-sm text-slate-700 dark:text-gray-300">
                  {{ item.id }}
                </span>
                <button
                  type="button"
                  :disabled="index === 0"
                  class="rounded p-1 text-slate-400 hover:bg-slate-100 hover:text-slate-700 disabled:opacity-40 dark:hover:bg-dark-600 dark:hover:text-gray-200"
        ...
        <div v-if="isProfitControlPlatform(createForm.platform)" class="border-t pt-4">
          ...
          <p class="mb-3 mt-1.5 text-xs text-slate-400 dark:text-slate-400">
            {{
        ...
        <div
          ...
          class="border-t border-slate-200 dark:border-dark-400 pt-4 mt-4"
        >
          <h4 class="text-sm font-medium text-slate-700 dark:text-gray-300 mb-3">
          ...
          <div>
            ...
            <div
              class="mt-2 rounded-xl bg-slate-50 p-3 text-xs text-slate-600 dark:bg-slate-800 dark:text-gray-300"
            >
              {{
        ...
        <div class="border-t border-slate-200 pt-4 mt-4 dark:border-dark-400">
          <div class="flex items-start justify-between gap-4">
            <div>
              <h4 class="text-sm font-medium text-slate-700 dark:text-gray-300">{{ t("admin.groups.modelPricing.title") }}</h4>
              <p class="mt-1 text-xs text-slate-400 dark:text-slate-400">{{ t("admin.groups.modelPricing.description") }}</p>
            </div>
          ...
          <label class="mt-3 flex items-start gap-2">
            ...
            <span><span class="block text-sm text-slate-700 dark:text-gray-300">{{ t("admin.groups.modelPricing.longContext") }}</span><span class="block text-xs text-slate-400">{{ t("admin.groups.modelPricing.longContextHint") }}</span></span>
          </label>
        ...
        <div
          ...
          class="border-t border-slate-200 dark:border-dark-400 pt-4 mt-4"
        >
          <h4 class="text-sm font-medium text-slate-700 dark:text-gray-300 mb-1">
        ...
        >
          ...
          >
            ...
            >
              <div
                class="border-b border-slate-100 bg-slate-50/80 px-4 py-3 dark:border-slate-800 dark:bg-slate-800/50"
              >
            ...
            <div
              class="mt-5 relative overflow-hidden rounded-xl border border-primary-200 bg-white shadow-sm dark:border-primary-900/50 dark:bg-slate-900"
            >
              <div
              ...
              <div class="p-4 bg-slate-50/30 dark:bg-slate-900/30">
                <div
                  v-if="createForm.exact_model_mappings.length === 0"
                  class="flex items-center justify-between gap-3 rounded-xl border-2 border-dashed border-primary-200 bg-white px-5 py-4 text-sm text-primary-700 transition-colors hover:border-primary-300 dark:border-primary-900/40 dark:bg-slate-900 dark:text-primary-300 dark:hover:border-primary-800"
                >
                  <span>{{
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-xl border border-slate-200 bg-white p-4 shadow-sm transition-all hover:border-primary-300 hover:shadow-md dark:border-slate-700 dark:bg-slate-800 dark:hover:border-primary-700"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            "
                            class="input bg-slate-50 focus:bg-white dark:bg-slate-900 dark:focus:bg-dark-900"
                          />
                        </div>
                        <div
                      ...
                      <button
                        ...
                        class="mt-6 flex h-9 w-9 items-center justify-center rounded-xl text-slate-400 transition-colors hover:bg-red-50 hover:text-red-500 dark:hover:bg-red-900/20 dark:hover:text-red-400"
                        :title="
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
                    class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-300 bg-white py-3 text-sm font-medium text-slate-400 transition-all hover:border-primary-300 hover:bg-primary-50/50 hover:text-primary-600 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-400 dark:hover:border-primary-800 dark:hover:bg-primary-900/20 dark:hover:text-primary-400"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
        ...
        <div
          ...
          "
          class="border-t border-slate-200 dark:border-dark-400 pt-4 mt-4 space-y-4"
        >
          <h4 class="text-sm font-medium text-slate-700 dark:text-gray-300 mb-3">
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          ...
          <p
            ...
            class="text-xs text-slate-400 dark:text-slate-400 mb-3"
          >
            {{ t("admin.groups.modelRouting.disabledHint") }}
          </p>
          <p v-else class="text-xs text-slate-400 dark:text-slate-400 mb-3">
            ...
            >
              <div class="flex items-start gap-3">
                      ...
                      <div
                        v-if="
                          ...
                          accountSearchResults[getCreateRuleSearchKey(rule)]
                            ?.length > 0
                        "
                        class="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-xl border bg-white shadow-lg dark:border-slate-700 dark:bg-slate-900"
                      >
                        <button
                          ...
                          class="w-full px-3 py-2 text-left text-sm hover:bg-slate-100 dark:hover:bg-dark-700"
                          :class="{
                ...
                <button
                  ...
                  class="mt-5 p-1.5 text-slate-400 hover:text-red-500 transition-colors"
        ...
        <div class="border-t pt-4">
          ...
          >
            ...
            <div
              class="max-h-64 space-y-2 overflow-y-auto p-2"
            >
              <p v-if="editModelsListLoading" class="text-xs text-slate-400 dark:text-slate-400">
                {{ t("admin.groups.modelsList.loading") }}
              </p>
              <p
