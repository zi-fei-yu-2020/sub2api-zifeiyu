          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center space-x-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-xl p-1.5 text-gray-500 transition-colors hover:bg-blue-50 hover:text-primary-600 dark:hover:bg-blue-900/20 dark:hover:text-green-400"
