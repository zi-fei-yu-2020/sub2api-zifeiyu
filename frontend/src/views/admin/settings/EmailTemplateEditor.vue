<template>
  <div class="card">
    <div
      class="flex flex-col gap-3 border-b border-slate-100 px-6 py-4 dark:border-slate-800 lg:flex-row lg:items-start lg:justify-between"
    >
      <div>
    ...
    <div class="space-y-6 p-6">
      <div
        v-if="loadingList"
        class="flex items-center gap-2 text-sm text-slate-400 dark:text-slate-400"
      >
        <span
      ...
      <template v-else>
        ...
        >
          <div class="flex flex-wrap items-center gap-2">
            ...
            <span
              class="rounded-full bg-white px-2.5 py-1 text-xs font-medium text-slate-600 shadow-sm ring-1 ring-gray-200 dark:bg-slate-900 dark:text-gray-300 dark:ring-dark-600"
            >
        ...
        <div
          ...
          class="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-700 dark:border-amber-800 dark:bg-amber-900/20 dark:text-amber-300"
        >
        ...
        <div v-else class="grid grid-cols-1 gap-6 xl:grid-cols-2">
            ...
            >
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <button
                  ...
                  :key="placeholder"
                  type="button"
                  class="rounded-full border border-slate-200 bg-white px-3 py-1 font-mono text-xs text-slate-700 transition-colors hover:border-primary-300 hover:text-primary-600 dark:border-slate-700 dark:bg-slate-800 dark:text-gray-200 dark:hover:border-primary-500 dark:hover:text-primary-300"
          ...
          <div class="space-y-4">
            ...
            >
              ...
              <div class="bg-slate-100 p-3 dark:bg-dark-900">
                <iframe
                  class="h-[36rem] w-full rounded-xl border border-slate-200 bg-white dark:border-slate-800"
                  sandbox=""
                  :srcdoc="previewHtml"
