<template>
  <AuthLayout>
    <div class="space-y-6">
      ...
      <!-- 蓝白色微光 Loading 动画指示器 -->
      <div v-if="isProcessing" class="flex flex-col items-center justify-center py-6 space-y-4">
        <div class="relative flex h-14 w-14 items-center justify-center rounded-2xl bg-blue-50 dark:bg-dark-700/60 shadow-inner">
          <svg class="h-7 w-7 animate-spin text-primary-600 dark:text-primary-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
        </div>
        <div class="w-48 h-1.5 overflow-hidden rounded-full bg-slate-100 dark:bg-dark-700">
          <div class="h-full w-full bg-gradient-to-r from-blue-500 to-sky-400 animate-pulse"></div>
        </div>
      </div>
