export default {
  ...
  version: {
    ...
    upstreamUpdateAvailable: '上游有新版本可用',
    releaseNotes: '更新日志',
    ...
    customModeHint:
      '当前为 zifeiyu 二开版本，请同步上游代码并测试后重新构建 Docker 镜像；已禁用上游二进制在线更新。',
    updateNow: '立即更新',
    updating: '正在更新...',
    updateComplete: '更新完成',
    updateFailed: '更新失败',
    ...
    rollbackCustomHint: '二开版本不支持使用上游二进制在线回退，请通过 Git 和 Docker 镜像执行版本回退。',
    deployScript: '脚本部署',
    deployDocker: 'Docker',
