  ...
  >
    <div class="space-y-4">
      ...
      <div v-else class="space-y-4">
        <div class="rounded-lg border border-blue-200 bg-emerald-50 p-3 text-sm text-emerald-800 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-300">
