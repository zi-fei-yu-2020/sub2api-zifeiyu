        ...
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start">
          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              ...
              <div class="space-y-1">
                <p class="truncate text-sm text-slate-600 dark:text-gray-300">
                  {{ primaryEmailDisplay }}
                </p>
                <div
                  v-if="sourceHints.length"
                  class="flex flex-wrap gap-2 text-xs text-slate-400 dark:text-slate-400"
                >
                  <span
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              ...
              >
                <p class="text-xs font-medium uppercase tracking-[0.16em] text-slate-400 dark:text-slate-400">
    ...
    <div class="space-y-6">
      <div data-testid="profile-main-column" class="space-y-6">
        <section
          ...
          class="card border border-slate-100 bg-white/90 p-6 dark:border-slate-800 dark:bg-dark-900/50"
        >
          ...
          <div class="grid gap-6 sm:grid-cols-1 md:grid-cols-2">
            <div class="rounded-3xl border border-slate-100 bg-slate-50/80 p-5 dark:border-slate-800 dark:bg-dark-900/30">
              <ProfileAvatarCard
                :user="user"
                embedded
              />
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            <div
              v-for="hint in sourceHints"
              :key="hint.key"
              class="flex items-start gap-3 rounded-2xl border border-slate-100 bg-slate-50/80 px-4 py-3 text-sm text-slate-600 dark:border-slate-800 dark:bg-dark-900/30 dark:text-gray-300"
            >
              <Icon name="link" size="sm" class="mt-0.5 text-slate-400 dark:text-slate-400" />
              <span>{{ hint.text }}</span>
            </div>
          </div>
        </section>
