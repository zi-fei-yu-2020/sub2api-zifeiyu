  ...
  <div class="card">
    ...
    <div class="px-6 py-6">
      ...
      <div v-else-if="status && !status.feature_enabled" class="flex items-center gap-4 py-4">
        <div class="flex-shrink-0 rounded-full bg-slate-100 p-3 dark:bg-slate-800">
        ...
        <div>
          <p class="font-medium text-slate-700 dark:text-gray-300">
      ...
      <div v-else-if="status?.enabled" class="flex items-center justify-between">
        <div class="flex items-center gap-4">
          <div class="flex-shrink-0 rounded-full bg-green-100 p-3 dark:bg-green-900/30">
            <svg class="h-6 w-6 text-primary-600 dark:text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
          ...
          <div>
            ...
            <p v-if="status.enabled_at" class="text-sm text-slate-400 dark:text-slate-400">
