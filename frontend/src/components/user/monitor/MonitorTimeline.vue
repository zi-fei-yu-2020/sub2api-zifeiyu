<template>
  <div class="mt-4 pt-3 border-t border-slate-100 dark:border-slate-800/60">
    <div
      class="flex justify-between text-[10px] font-semibold uppercase tracking-widest text-slate-400 mb-2"
    >
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-slate-300 dark:border-slate-700 text-[10px] uppercase tracking-widest text-slate-400"
    >
    ...
    <div
      class="mt-1 flex justify-between text-[9px] uppercase tracking-widest text-slate-400"
    >
