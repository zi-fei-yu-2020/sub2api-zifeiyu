  ...
  <div class="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-900/50">
    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <div class="mt-1 text-xs text-slate-400 dark:text-dark-400">
    ...
    <div v-if="mode === 'custom'" class="mt-4 space-y-4">
      <div class="flex items-center justify-between">
        <div class="text-sm font-medium text-slate-900 dark:text-white">
          OR
          <span class="ml-1 text-xs font-normal text-slate-400 dark:text-dark-400">
            ({{ anyOf.length }}/50)
          </span>
        </div>
        <button
      ...
      <div v-if="anyOf.length === 0" class="rounded-xl border border-dashed border-slate-300 p-4 text-sm text-slate-400 dark:border-slate-700 dark:text-dark-400">
      ...
      >
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            <div class="text-sm font-medium text-slate-900 dark:text-white">
              ...
              <span class="ml-2 text-xs font-normal text-slate-400 dark:text-dark-400">AND ({{ (group.all_of?.length || 0) }}/50)</span>
            </div>
            <div class="mt-1 text-xs text-slate-400 dark:text-dark-400">
        ...
        <div class="mt-4 space-y-3">
          <div
            ...
            :key="condIndex"
            class="rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-dark-900/30"
          >
