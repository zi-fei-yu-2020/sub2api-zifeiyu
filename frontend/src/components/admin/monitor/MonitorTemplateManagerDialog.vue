      ...
      <div role="tablist" class="flex flex-wrap gap-1">
        ...
        >
          ...
          <span
            ...
            class="ml-1.5 rounded-full bg-slate-100 px-2 py-0.5 text-xs dark:bg-slate-800"
          >
        ...
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0 flex-1">
            <div class="flex items-center gap-2">
              ...
              <span
                class="inline-flex items-center rounded-xl px-1.5 py-0.5 text-xs"
            ...
            <p v-if="tpl.description" class="mt-0.5 text-xs text-slate-400 dark:text-slate-400">
              {{ tpl.description }}
            </p>
...
function tabClass(value: Provider): string {
  return activeProvider.value === value
    ...
    : 'border-b-2 border-transparent text-slate-400 hover:text-slate-700 dark:text-slate-400 dark:hover:text-gray-200'
}
