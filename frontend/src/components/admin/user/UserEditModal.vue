      ...
      <div>
        ...
        <div class="flex gap-2">
          <div class="relative flex-1">
            ...
            <button v-if="form.password" type="button" @click="copyPassword" class="absolute right-2 top-1/2 -translate-y-1/2 rounded-xl p-1 transition-colors hover:bg-slate-100 dark:hover:bg-dark-700" :class="passwordCopied ? 'text-green-500' : 'text-slate-400'">
