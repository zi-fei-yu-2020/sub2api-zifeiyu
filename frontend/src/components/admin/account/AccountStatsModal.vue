    ...
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-blue-200 bg-gradient-to-br from-emerald-50 to-white p-4 dark:border-emerald-800/30 dark:from-emerald-900/10 dark:to-dark-700"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-slate-400 dark:text-slate-400">{{
                t('admin.accounts.stats.totalCost')
              }}</span>
              <div class="rounded-xl bg-emerald-100 p-1.5 dark:bg-emerald-900/30">
                <Icon name="dollar" size="sm" class="text-blue-600 dark:text-emerald-400" />
              </div>
            </div>
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-xl bg-blue-100 p-1.5 dark:bg-blue-900/30">
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-xl bg-amber-100 p-1.5 dark:bg-amber-900/30">
                <Icon
                  name="calculator"
                  size="sm"
          ...
          >
            <div class="mb-2 flex items-center justify-between">
              ...
              <div class="rounded-xl bg-purple-100 p-1.5 dark:bg-purple-900/30">
                <svg
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-xl bg-cyan-100 p-1.5 dark:bg-cyan-900/30">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-slate-400 dark:text-slate-400">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-slate-900 dark:text-white"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-slate-400 dark:text-slate-400">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-slate-900 dark:text-white"
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-xl bg-orange-100 p-1.5 dark:bg-orange-900/30">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-xl bg-indigo-100 p-1.5 dark:bg-indigo-900/30">
                <Icon
                  name="trendingUp"
                  size="sm"
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-xl bg-teal-100 p-1.5 dark:bg-teal-900/30">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-xl bg-rose-100 p-1.5 dark:bg-rose-900/30">
          ...
          <div class="card p-4">
            <div class="mb-3 flex items-center gap-2">
              <div class="rounded-xl bg-lime-100 p-1.5 dark:bg-lime-900/30">
                <Icon
                  name="clipboard"
                  size="sm"
      ...
      <div
        v-else-if="!loading"
        class="flex flex-col items-center justify-center py-12 text-slate-400 dark:text-slate-400"
      >
