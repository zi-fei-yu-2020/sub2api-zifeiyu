      ...
      <div class="divide-y divide-gray-100 dark:divide-dark-800">
        ...
        >
          ...
          <div class="min-w-0">
            ...
            <p v-if="probeResults[endpoint.id]" class="mt-1.5 line-clamp-2 text-xs leading-5" :class="probeResults[endpoint.id].ok ? 'text-blue-600 dark:text-emerald-300' : 'text-red-600 dark:text-red-300'">
